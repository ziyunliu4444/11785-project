...
parser.add_argument('--ballroom_audio_dir', type=str, default='./datasets/BallroomData')
parser.add_argument('--ballroom_annot_dir', type=str, default='./datasets/ISMIR2019/ballroom/annotations/beats')
parser.add_argument('--hainsworth_audio_dir', type=str, default='./datasets/Hainsworth/wavs')
parser.add_argument('--hainsworth_annot_dir', type=str, default='./datasets/ISMIR2019/hainsworth/annotations/beats')
...
parser.add_argument('--gtzan_audio_dir', type=str, default='./datasets/GTZAN/genres_original')
parser.add_argument('--gtzan_annot_dir', type=str, default='./datasets/ISMIR2019/gtzan/annotations/beats')
parser.add_argument('--smc_audio_dir', type=str, default='./datasets/SMC_MIREX/SMC_MIREX_Audio')
parser.add_argument('--smc_annot_dir', type=str, default='./datasets/ISMIR2019/smc/annotations/beats')
